    ...
    >
      <div className="gocptContainer px-8 md:px-16 py-4 flex flex-col items-center mb-12">
        ...
        <div className="cardContainer drop-shadow-[0_0_100px_black] shadow-black/20 border border-white/20 rounded-md flex flex-col items-center py-12 px-4 backdrop-blur-lg">
          <p className="text-center text-4xl max-sm:text-xl underline">
            Ensuring CPT Code Accuracy with <br />
            <span className="font-[700]">CoGPT</span> App
          </p>
          ...
          <p className="text-xs w-3/4 py-12 text-center font-extralight font-[offside]">
