...
const CallToAction = () => {
  ...
  return (
    ...
    >
      ...
      <p className="text-[14px] md:px-8 w-4/5 text-center font-[offside] font-extrathin">
      ...
      <Link
        to="/signup"
        className="px-2 text-2xl max-sm:text-lg bg-gradient-to-b from-[#5f5182] to-[#2e3254] rounded-md border border-pinkPrimary/80 flex shadow-[0_0_50px_#ffffff99]"
      >
        Sign Up Today!
      </Link>
    </section>
