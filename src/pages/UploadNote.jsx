  ...
  return (
    ...
    >
      ...
      >
        ...
        <button className="bg-black/30 border border-black/30 px-20 shadow-[0_0_10px_black] text-2xl max-lg:text-lg">
          MEDIUM
        </button>
        ...
        <div className="flex justify-around w-full md:px-12 px-4 md:gap-12 gap-6">
          <div className="flex flex-col items-center justify-between w-1/2 gap-2">
            <input
              ...
              className="w-full rounded-lg border border-black/25 bg-black/5 backdrop-blur-md placeholder:text-white/70 px-2 py-1"
            />
            <button className="w-full rounded-lg bg-gradient-to-b from-[#F197F4BF] to-[#2B3A63BF] hover:bg-gradient-to-t px-2 py-1 text-xl border border-white/85">
              SUBMIT
            </button>
            <div className="w-full rounded-lg border border-black/25 text-center bg-black/15 text-xl max-lg:text-lg">
              99214
            </div>
          </div>
          <div className="flex flex-col items-center justify-between w-1/2 gap-2">
